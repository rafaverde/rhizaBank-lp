    ...
    <header className="sticky top-0 z-50 flex h-20 w-full items-center bg-rhiza-green-100">
      ...
      <div className="flex w-full max-w-[1170px] items-center justify-between px-4 lg:m-auto xl:p-0">
        ...
        <nav
          ...
          id="header_menu"
          className={`${isOpen ? "translate-x-0" : "translate-x-[100%]"} absolute left-0 top-20 w-full flex-1 items-center transition-transform duration-700 ease-in-out lg:relative lg:top-0 lg:ml-20 lg:flex lg:translate-x-0`}
        >
